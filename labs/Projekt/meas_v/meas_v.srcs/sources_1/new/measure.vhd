...
use ieee.numeric_std.all; -- definovany aritmeticke operace
...
architecture Behavioral of tlc is
    ...
    -- Define the states
    -- vyctovy typ
    type t_state is (WAIT_S1,
                     WAIT_S2,
                     WAIT_S3,
                     WAIT_S4,
                     SOUTH_GO,
                     SOUTH_WAIT);
    -- vnitrni signal obsahujici tech 6 hodnot - predstavuje stavovou velicinu
    ...
    constant c_DELAY_4SEC : unsigned(4 downto 0) := b"1_0000"; -- 16krat 250 ms (coz je nase upravena casova zakladna) = 4 s
    constant c_DELAY_2SEC : unsigned(4 downto 0) := b"0_1000"; -- 8krat 250 ms = 2 s
    constant c_DELAY_1SEC : unsigned(4 downto 0) := b"0_0100"; -- 1 s
    constant c_ZERO       : unsigned(4 downto 0) := b"0_0000"; -- 0 s

    -- Output values
    constant c_RED        : std_logic_vector(2 downto 0) := b"100"; -- R
    constant c_YELLOW     : std_logic_vector(2 downto 0) := b"110"; -- R+G = Y
    constant c_GREEN      : std_logic_vector(2 downto 0) := b"010"; -- G
...
begin
    ...
    -- pro SIMULACI si clock enable nastavim na 1
    -- s_en <= '1';
    ...
    -- spousten pri zmene stavu (predstavuje kombinacni cast FSM  
